...
This tag with prefix \inlinecode{!new:} creates an instance of the specified class. If the node is a mapping node, like in the example above, the items are passed as keyword arguments to the class.
